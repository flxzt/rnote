...
impl Transformable for QuadraticBezier {
    ...
    fn rotate(&mut self, angle: f64, center: Vector2) {
        ...
        self.cp = pose.transform_point(self.cp);
...
fn quad_bezier_derive_coeff_a(p0: Vector2, p1: Vector2, p2: Vector2) -> Vector2 {
    2.0 * p2 - 4.0 * p1 + 2.0 * p0
}

/// Coefficient b of quadratic bezier derivation in polynomial form: C' = a * t + b
fn quadbez_derive_coeff_b(p0: Vector2, p1: Vector2) -> Vector2 {
    2.0 * p1 - 2.0 * p0
}

#[allow(unused)]
/// calculating the derivative of the bezier curve for t: between 0.0 and 1.0
pub fn quadbez_derive_calc(p0: Vector2, p1: Vector2, p2: Vector2, t: f64) -> Vector2 {
