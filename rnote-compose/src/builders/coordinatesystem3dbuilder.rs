...
#[derive(Debug, Clone)]
pub struct CoordinateSystem3DBuilder {
...
impl ShapeBuilderCreator for CoordinateSystem3DBuilder {
...
impl ShapeBuilderBehaviour for CoordinateSystem3DBuilder {
    fn handle_event(
        &mut self,
        event: PenEvent,
        _now: Instant,
...
impl CoordinateSystem3DBuilder {
